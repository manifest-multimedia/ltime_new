...
@section("content")
    ...
    <h5>Admin - Add New Article</h5>
    <p>Change language option to translate your article in a different language</p>
    ...
    'post_translation' => $post_translation
        ...
        <input class="mb-5" type='submit' name="submit_btn" class='btn btn-primary' value='Add new post' >
