...
@section("content")
    ...
    @empty
        <div class='alert alert-warning'>No articles to show you. Why don't you <a style="text-decoration: none !important" href="manage-insights/add_post">add one?</a></div>
    @endforelse
