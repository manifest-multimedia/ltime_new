...
<head>
    ...
    <title>Manage Insights - L-Time Properties </title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{url('/portal/dashboard')}}'>Return to Admin Dashboard</a></li>
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("binshopsblog.index" , app('request')->get('locale'))}}' target="_blank">View Insights on Website</a></li>
            ...
            <div class='row full-width-div nav-bar-full'>
                <div class='list-group-color'>
                    ...
                    <div class=' list-group-color text-center mt-5 mb-3 text-muted binshops-version'>
                        <small><a href='https://github.com/binshops/laravel-blog'>System </a></small>
