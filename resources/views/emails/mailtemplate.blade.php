...
<head>
	...
	<!--<![endif]-->
	<title>L-Time Properties LTD</title>
	<!--[if gte mso 9]>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="https://ltimepropertiesltd.com" target="_blank"><img src="{{asset('assets/images/logo.png')}}" width="100" height="43" border="0" alt="Logo" /></a>
																			</td>
																		</tr>
																	</table>
																	<!-- Logo -->
																											...
																											<tr>
																												{{-- <td class="btn-16 c-white l-white" bgcolor="#f3189e" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																													<a href="#" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																														<span class="link c-white" style="text-decoration:none; color:#ffffff;">GET STARTED</span>
																													</a>
																												</td> --}}
																											</tr>
																										</table>
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<tr>
																									<td class="title-26 a-center pb-35" style="font-size:26px; line-height:30px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 35px;">
																										<strong>Insights from our Team!</strong>
																									</td>
																								</tr>
																								<tr>
																									<td class="pb-35" style="padding-bottom: 35px;">
																										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																											<tr>
																												<td valign="top" class="img-center" width="75" style="font-size:0pt; line-height:0pt; text-align:center;">
																													<img src="{{asset('blog_images/the-future-of-sustainable-design-in-real-estate-0lezv-600x400.jpg')}}" style="object-fit:cover; height:75px; width:75px" width="75" height="75" border="0" alt="" />
																												</td>
																												<td valign="top" class="img mw-15" width="30" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																												<td valign="top">
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
																														<tr>
																															<td class="title-20 pb-5" style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; padding-bottom: 5px;">
																																<strong>The Future of Sustainable Design in Real Estate</strong>
																															</td>
																														</tr>
																														<tr>
																															<td class="text-14 lh-24" style="font-size:14px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 24px;">
                                                                                                                                Sustainable design is becoming increasingly important in the real estate industry, as developers and property owners seek to reduce environmental impact and improve the health and wellness of building occupants. 
                                                                                                                            </td>
																														</tr>
																													</table>
																												</td>
																								...
																								{{-- <tr>
																									<td class="pb-35" style="padding-bottom: 35px;">
																										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																											<tr>
																												<td valign="top" class="img-center" width="75" style="font-size:0pt; line-height:0pt; text-align:center;">
																													<img src="../images/ico_mail.png" width="75" height="75" border="0" alt="" />
																												</td>
																												<td valign="top" class="img mw-15" width="30" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																												<td valign="top">
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
																									<td class="pb-35" style="padding-bottom: 35px;">
																										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																											<tr>
																												<td valign="top" class="img-center" width="75" style="font-size:0pt; line-height:0pt; text-align:center;">
																													<img src="../images/ico_hi.png" width="75" height="75" border="0" alt="" />
																												</td>
																												<td valign="top" class="img mw-15" width="30" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																												<td valign="top">
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<table border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_facebook.png" width="34" height="34" border="0" alt="" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_instagram.png" width="34" height="34" border="0" alt="" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_twitter.png" width="34" height="34" border="0" alt="" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_pinterest.png" width="34" height="34" border="0" alt="" /></a>
																				</td>
																			</tr>
																		</table>
																		<!-- END Socials -->
																...
																<tr>
																	<td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
																		Near GreenVille Hospital Community 26
																		<br />
																		<a href="tel:+233206958652" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">+233 (0)206958652</span></a> - <a href="tel:+233243407156" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">+233 (0)243407156</span></a>
																		<br />
																		<a href="mailto:info@ltimepropertiesltd.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">info@ltimepropertiesltd.com</span></a> - <a href="https://ltimepropertiesltd.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">www.ltimepropertiesltd.com</span></a>
																	</td>
																</tr>
																<tr>
																	{{-- <td align="center">
																		...
																		<table border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/btn_appstore.png" width="117" height="40" border="0" alt="" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/btn_gplay.png" width="117" height="40" border="0" alt="" /></a>
																				</td>
																			</tr>
																		</table>
																		<!-- END Download App -->
